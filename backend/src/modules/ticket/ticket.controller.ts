...
export async function create(req: FastifyRequest, reply: FastifyReply) { return success(reply, await ticketService.createTicket(req.currentUser!.id, req.body as any), '工单已提交', 201); }
...
export async function createHelp(req: FastifyRequest, reply: FastifyReply) { return success(reply, await ticketService.createHelp(req.body as any), '创建成功', 201); }
...
export async function createAnnouncement(req: FastifyRequest, reply: FastifyReply) { return success(reply, await ticketService.createAnnouncement(req.body as any), '创建成功', 201); }
